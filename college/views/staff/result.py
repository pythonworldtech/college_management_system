...
def staff_add_result(request):
          if request.session.has_key('email'):
                    ...
                    return render(request, 'staff/add_result.html',data)
...
def staff_view_result(request):
          if request.session.has_key('email'):
                    ...
                    return render(request, 'staff/view_result.html',data)
          else:
                    return redirect('login')
...
#============================ Staff Edit Student Result ====================================

def staff_edit_result(request,pk):
          if request.session.has_key('email'):
                    email = request.session["email"]
                    admin = Login.objects.filter(email=email)
                    ...
                    if request.method=="POST":
                              ...
                              return redirect(f"/staff_edit_result{pk}")
                    ...
                    return render(request, 'staff/edit_result.html',data)
          else:
                    return redirect('login')
...
#============================ Staff Delete Student Result =================================

def staff_delete_result(request,pk):
    if request.session.has_key('email'):
        result= Result.objects.filter(id=pk)
        result.delete()
